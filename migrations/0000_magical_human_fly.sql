...
--> statement-breakpoint
CREATE UNIQUE INDEX `images_objectKey_unique` ON `images` (`object_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `images_md5_unique` ON `images` (`md5`);--> statement-breakpoint
CREATE UNIQUE INDEX `images_md5_idx` ON `images` (`md5`);--> statement-breakpoint
